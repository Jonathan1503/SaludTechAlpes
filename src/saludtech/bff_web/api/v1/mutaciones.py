...
class Mutation:
    ...
    @strawberry.mutation
    async def crear_reserva(self, id_partner: str, id_proceso_ingestion: str, imagenes: str, info: Info) -> ProcesoIngestionRespuesta:
        ...
        return ProcesoIngestionRespuesta(mensaje="Procesando Mensaje", codigo=203)