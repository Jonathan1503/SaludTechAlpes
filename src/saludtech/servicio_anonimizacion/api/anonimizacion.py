...
def proceso_anonimizacion_asincronica():
    try:
        ...
        comando = CrearProcesoAnonimizacion(proceso_anonimizacion_dto.fecha_creacion, proceso_anonimizacion_dto.fecha_actualizacion, proceso_anonimizacion_dto.id, proceso_anonimizacion_dto.datos, proceso_anonimizacion_dto.id_partner)
